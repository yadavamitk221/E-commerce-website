      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        {/* This is bottom page numbering */}
         <p className="text-sm text-gray-700">
            ...
            to <span className="font-medium">{page * ITEMS_PER_PAGE > totalItems ?  totalItems: page * ITEMS_PER_PAGE}</span>{" "}
          ...
          >
            ...
            {Array.from({ length: Math.ceil(totalItems / ITEMS_PER_PAGE) }).map(
              ...
              (el, idx) => (
                ...
                aria-current="page"
                className={`relative z-10 inline-flex items-center ${idx+1===page? `bg-indigo-600 text-white` : "text-black-400" } cursor-pointer px-4 py-2 text-sm font-semibold focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
                >
                {idx + 1}
                </div>
              )
