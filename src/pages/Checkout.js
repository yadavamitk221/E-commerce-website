...
function Checkout() {
  ...
  const handleOrder = (e) => {
    if(selectedAddress && paymentMethod){
      ...
      // Need to redirect from here to new page of success.
    }else{
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-12 bg-white max-w-7xl px-2 py-2 sm:px-2 lg:px-2">
              <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div className="flow-root">
                  <ul
                    role="list"
                    className="-my-6 divide-y px-0 divide-gray-200 sm:px-0"
                  >
                    {items.map((item) => (
              ...
              <div className="mx-auto max-w-7xl px-4 py-6 sm:px-4 lg:px-4">
